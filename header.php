...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$suzannepach_portfolio_wp_description = get_bloginfo( 'description', 'display' );
			if ( $suzannepach_portfolio_wp_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $suzannepach_portfolio_wp_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
